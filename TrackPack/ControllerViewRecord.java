...
public class ControllerViewRecord implements Initializable {

    @FXML MenuBar menuBar;
    @FXML TableView<Exercise> recordView;
    @FXML TableColumn<Exercise, String> dateCVR, exerciseCVR;
    @FXML TableColumn<Exercise, Double> weightCVR, totalLiftedCVR;
    @FXML TableColumn<Exercise, Integer> repsCVR, setsCVR;

    Record record;

    @Override
    public void initialize(URL location, ResourceBundle resources){
        dateCVR.setCellValueFactory(new PropertyValueFactory<>("date"));
        exerciseCVR.setCellValueFactory(new PropertyValueFactory<>("exercise"));
        weightCVR.setCellValueFactory(new PropertyValueFactory<>("weight"));
        repsCVR.setCellValueFactory(new PropertyValueFactory<>("reps"));
        setsCVR.setCellValueFactory(new PropertyValueFactory<>("sets"));
        totalLiftedCVR.setCellValueFactory(new PropertyValueFactory<>("totalLifted"));
